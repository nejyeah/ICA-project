...
int main(int argc,char **argv){
    ...
    const string inputFileName="minist2_lc_t2.dat";
    ...
    const string outfilename="minist3_w_t2.dat";
    const string h_filename="minist3_h_t2.dat";
    const string p_filename="minist3_p_t2.dat";
    const string lcn_filename="minist3_lc_t2.dat";
