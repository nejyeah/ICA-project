...
int main(int argc,char **argv){
    ...
    const int input_col=12;
    const int input_channel=3;
    const string inputFileName="minist2_outcome_t4_test.dat";
    ...
    const string outfilename="minist3_w_t4.dat";
    const string h_filename="minist3_h_t4_test.dat";
    const string p_filename="minist3_p_t4_test.dat";
    const string lcn_filename="minist3_outcome_t4_test.dat";
    //const string R_0_file="minist3_R0_t2.dat";
    //const string R_n_file="minist3_Rn_t2.dat";

    if(rank==0){
        cout<<"************************************************"<<endl;
        cout<<"-----------train_minist3--------"<<endl;
