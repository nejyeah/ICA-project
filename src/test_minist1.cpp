...
int main(int argc,char **argv){
    ...
    const string inputFileName="../data/MINIST/t10k-images.idx3-ubyte";
    ...
    const string outfilename="minist1_w_t4.dat";
    const string h_filename="minist1_h_t4_test.dat";
    const string p_filename="minist1_p_t4_test.dat";
    const string lcn_filename="minist1_outcome_t4_test.dat";
    if(rank==0){
        cout<<"************************************************"<<endl;
