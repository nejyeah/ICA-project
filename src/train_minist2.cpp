...
int main(int argc,char **argv){
    ...
    const string inputFileName="minist1_lc_t1.dat";
    const int picture_number=50000;
    ...
    //float alpha=0.144107;
    float alpha=0.0279849;
    //use for projected gradient
    const float theata=0.0001;
    //use for lcn
    const float c=0.65;
    //E=E1+ela*E2
    const float ela=0.05;
    //w=w+learning_rate*delta_W+u*delta_W_mconst float learning_rate=12;
    const float learning_rate=100;
    const float alpha_learning_rate=0.00001;
    const float u=0.5;
    if(rank==0){
        cout<<"************************************************"<<endl;
    ...
    const string outfilename="minist2_w_t2_4.dat";
    const string h_filename="minist2_h_t2_4.dat";
    const string p_filename="minist2_p_t2_4.dat";
    const string lcn_filename="minist2_lc_t2_4.dat";
    const string R_0_file="minist2_R0_t2_4.dat";
    const string R_n_file="minist2_Rn_t2_4.dat";
    ...
    if(rank==0) firstlayer.loaddata_w("minist2_w_t2_3.dat");
