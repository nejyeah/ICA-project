...
int main(int argc,char **argv){
    ...
    const string inputFileName="../data/MINIST/train-images.idx3-ubyte";
    ...
    const float learning_rate=20;
    const float alpha_learning_rate=0.001;
    const float u=0.005;
    const string outfilename="minist1_w_t2.dat";
    const string h_filename="minist1_h_t2.dat";
    const string p_filename="minist1_p_t2.dat";
    const string lcn_filename="minist1_outcome_t2.dat";
    const string R_0_file="minist1_R0_t2.dat";
    const string R_n_file="minist1_Rn_t2.dat";
    if(rank==0){
        cout<<"************************************************"<<endl;
        cout<<"-----------train_minist1--------"<<endl;
